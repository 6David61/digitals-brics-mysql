...
function UpdateAdminElement({
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (element === "services") {
        await axios.put(`${baseUrl}/services/${parseInt(id)}`, formattedData, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${accessToken}`,
          },
        });
      } else if (element === "putes") {
        await axios.put(`${baseUrl}/putes/${parseInt(id)}`, formattedData, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${accessToken}`,
          },
        ...
        await axios.put(`${baseUrl}/positions/${parseInt(id)}`, formattedData, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${accessToken}`,
          },
        ...
        await axios.put(
          `${baseUrl}/categories/${parseInt(id)}`,
          formattedData,
          {
            headers: {
              "Content-Type": "application/json",
      ...
      } else if (element === "roles tache") {
        await axios.put(`${baseUrl}/roles/${parseInt(id)}`, formattedData, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${accessToken}`,
          },
        ...
        await axios.put(`${baseUrl}/rolesPlan/${parseInt(id)}`, formattedData, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${accessToken}`,
          },
        ...
        await axios.put(
          `${baseUrl}/typePriorites/${parseInt(id)}`,
          formattedData,
          {
            headers: {
              "Content-Type": "application/json",
